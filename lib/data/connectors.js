...
//
// This file catalogs the DIRECTORY-ONLY connectors — they save credentials to
// the integrations table for future live-sync builds but do NOT currently
// pull data.
//
// Real live-sync providers (Gusto, BambooHR, QBO, Finch) render in a
// separate "Live payroll & HRIS sync" section on the Integrations page,
// backed by /api/payroll/status. They are intentionally NOT in this file
// so they cannot double-render or be mistaken for cosmetic entries.
//
// Categories: hris (8), ats (6), communication (3), storage (3),
//             identity (3), devops (2), billing (1) = 26 total
// =============================================================================

const CONNECTORS = {
  // ============ HRIS — 10 connectors ============
  hris: [
    // -- BambooHR removed from directory: it now lives in the "Live payroll & HRIS sync"
    //    section above with real API-key auth against BambooHR's directory endpoint. --
    {
    ...
    // -- Gusto removed from directory: it now lives in the "Live payroll & HRIS sync"
    //    section above with real OAuth against Gusto Embedded. --
    {
    ...
    // -- QBO and Finch removed from directory: both now live in the
    //    "Live payroll & HRIS sync" section above with real OAuth. --
  ],
