...
// Categories: hris (12), ats (6), communication (3), storage (3),
//             identity (3), devops (2), billing (1) = 30 total
// Live-sync providers (real OAuth/API-key backends): gusto, bamboohr, qbo, finch
// =============================================================================
  ...
  hris: [
    {
      ...
      // -- API-key connect: modal collects credentials, POSTs to this route
      //    which validates against BambooHR's own API before persisting. --
      apiKeyConnect: "/api/payroll/connect/bamboohr",
      liveSync: true,
    },
    {
    ...
    },
    {
      ...
      fields: [],                       // OAuth-only; no manual credential entry
      syncFields: ["employees", "payroll", "benefits", "timeOff"],
      webhooks: true, oauth: true, pricing: "Included",
      // -- When set, clicking Connect kicks off a real provider OAuth flow
      //    (see app/api/payroll/oauth/[provider]/route.js) instead of the
      //    generic cosmetic-credentials modal. --
      oauthStart: "/api/payroll/oauth/gusto",
      liveSync:   true,                 // renders a green "Live sync" badge
    },
    {
    ...
    {
      id: "qbo", name: "QuickBooks Online", color: "#2CA01C", category: "HRIS",
      desc: "Intuit's SMB accounting platform — pull employee roster + comp",
      fields: [],                       // OAuth-only; realmId captured on callback
      syncFields: ["employees", "departments"],
      webhooks: true, oauth: true, pricing: "Included",
      oauthStart: "/api/payroll/oauth/qbo",
      liveSync: true,
    },
    {
      id: "finch", name: "Finch (Unified)", color: "#6C63FF", category: "HRIS",
      desc: "One connection → ADP, Paychex, Paylocity, UKG and 25+ more",
      fields: [],
      syncFields: ["employees", "payroll", "benefits", "timeOff"],
      webhooks: true, oauth: true, pricing: "Included",
      oauthStart: "/api/payroll/oauth/finch",
      liveSync: true,
    },
  ],
